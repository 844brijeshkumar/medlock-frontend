    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Mission */}
          <div className="group relative bg-white rounded-[2rem] p-10 border border-gray-100 shadow-sm hover:-translate-y-2 hover:border-[var(--color-secondary)]/40 hover:shadow-2xl hover:shadow-[var(--color-secondary)]/10 transition-all duration-500 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto rounded-[3rem] overflow-hidden relative">
          ...
          <div className="relative z-10 px-8 py-20 md:px-20 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
              <Link
                to="/demo"
                className="group relative overflow-hidden bg-white text-[var(--color-primary)] px-8 py-4 rounded-2xl font-bold shadow-lg hover:scale-105 transition-all duration-300"
              >
                Request Demo
              </Link>
              <Link
