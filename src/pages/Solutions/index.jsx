        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-28 w-full">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 text-lg md:text-xl text-white/80 leading-relaxed max-w-3xl">
              MedLock provides scalable healthcare infrastructure for
              hospitals, diagnostics, insurance systems, analytics, and
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((item, index) => (
            ...
            >
              ...
              <p className="mt-3 text-gray-500 font-medium">{item.label}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mt-16">
          {solutions.map((solution, index) => (
            ...
            >
              ...
              {/* Button */}
              <button className="mt-10 w-full bg-[var(--color-primary)] text-white py-4 rounded-2xl font-bold hover:bg-[var(--color-secondary)] transition-all duration-300 flex items-center justify-center gap-2">
                Explore Solution
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
            {workflow.map((item, index) => (
              <div
                key={index}
                className="group relative bg-slate-50 rounded-[2rem] p-8 border border-gray-100 shadow-sm hover:-translate-y-2 hover:border-[var(--color-secondary)]/40 hover:shadow-2xl hover:shadow-[var(--color-secondary)]/10 transition-all duration-500 overflow-hidden"
              >
                {/* Accent */}
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />

                {/* Number */}
                <div className="text-6xl font-black text-[var(--color-secondary)]/20">
                  {item.step}
                </div>
